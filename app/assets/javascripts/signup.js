...
pages.eq(0).fadeIn();
  ...
  $('.next-step4').click(function (e) {
    ...
    if(!(number == "4242424242424242" || number == "4012888888881881" || number == "5555555555554444" || number == "5105105105105100" || number == "3530111333300000" ||number == "3566002020360505" || number == "378282246310005" || number == "371449635398431" || number == "38520000023237" || number == "30569309025904" || number == "6011111111111117" || number == "6011000990139424"))
    {
      $('#error-number2').text("カード番号が不正です");
    };
    if(month == "--")
    {
